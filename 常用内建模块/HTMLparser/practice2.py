        ...
        <div class="most-recent-events">
            <div class="shrubbery">
                ...
                <ul class="list-recent-events menu">
                    ...
                    <li>
                        <h3 class="event-title"><a href="/events/python-events/960/">Python for Signal Processing Algorithms Implementation (Tamilnadu)</a></h3>
                        <p>
                            
                            
<time datetime="2020-03-22T03:30:00+00:00">22 March<span class="say-no-more"> 2020</span> 3:30am UTC – 11:30am UTC</time>

                            

                            
                            <span class="event-location">ECE Department Seminar Hall, IRTT, Erode, Tamilnadu, INDIA</span>
...
<time datetime="2020-04-17T00:00:00+00:00">17 April<span class="say-no-more"> 2020</span></time>
                    ...
                    <li>
                        <h3 class="event-title"><a href="/events/python-events/910/">DragonPy 2020</a></h3>
                        <p>
                            
                            
<time datetime="2020-04-18T00:00:00+00:00">18 April &ndash; 19 April <span class="say-no-more"> 2020</span></time>

                            

                            
                            <span class="event-location">Ljubljana, Slovenia</span>
...
class MyHTMLParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if ('class', 'event-location') in attrs:
            self.__parsedata = 'add'
            # print(attrs)

            # print('<%s>' % tag)

    def handle_endtag(self, tag):
        self.__parsedata = '' # 清空标志位
        pass
        # print('<%s>' % tag)
